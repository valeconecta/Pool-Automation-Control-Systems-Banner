    ...
    <>
      <section className="relative min-h-[60vh] flex items-center py-24 text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://lh3.googleusercontent.com/d/1pw5CcDbb8zU8LnSEPWkx-KaRC4_wfVGE" 
              ...
              {gallery && gallery.length > 0 && (
                <div className="space-y-8 pt-8 border-t border-slate-100">
                  ...
                  <div className="relative group">
                    <div className="aspect-video rounded-3xl overflow-hidden shadow-2xl relative bg-slate-100">
                  ...
                  <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                    {gallery.map((img, idx) => (
                      <button
                        key={idx}
                        onClick={() => setCurrentIndex(idx)}
                        className={`relative shrink-0 w-24 aspect-video rounded-xl overflow-hidden border-2 transition-all ${idx === currentIndex ? 'border-brand-light scale-105' : 'border-transparent'}`}
                      >
